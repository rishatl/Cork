//
//  Onboarding Complexity Selector View.swift
//  Cork
//
//  Created by David Bureš on 10.01.2024.
//

import SwiftUI

struct ComplexitySelectorView: View
{
    ...
    @Binding var areDetailsExpanded: Bool
